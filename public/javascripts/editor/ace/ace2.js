...
(function() {
  ...
  window.sharejs.extendDoc('attach_ace', function(editor, keepEditorContents) {
    var check, deleteListener, doc, docListener, editorDoc, editorListener, 
insertListener, offsetToPos, refreshListener, replaceTokenizer, suppress;
    ...
    doc.on('refresh', refreshListener = function(startoffset, length) {
      ...
      range = Range.fromPoints(offsetToPos(startoffset), offsetToPos(startoffset + 
length));
