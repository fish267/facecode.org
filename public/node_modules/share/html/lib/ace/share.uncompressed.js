...
(function() {
  var BCSocket, Connection, Doc, MicroEvent, ReconnectingWebSocket, SockJS, 
WebSocket, append, bootstrapTransform, checkValidComponent, checkValidOp, exports, 
hasBCSocket, hasSockJS, invertComponent, nextTick, socketImpl, strInject, text, 
transformComponent, transformPosition, types,
    __slice = [].slice,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; 
},
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < 
...
1) : [];
  ...
  exports['_bt'] = bootstrapTransform = function(type, transformComponent, 
checkValidOp, append) {
    ...
    type.transformX = type['transformX'] = transformX = function(leftOp, rightOp) {
      var k, l, l_, newLeftOp, newRightOp, nextC, r, r_, rightComponent, _i, _j, _k, 
_l, _len, _len1, _len2, _len3, _ref, _ref1;
      ...
      for (_i = 0, _len = rightOp.length; _i < _len; _i++) {
        ...
        while (k < leftOp.length) {
          ...
          if (nextC.length === 1) {
            ...
            _ref1 = transformX(leftOp.slice(k), nextC), l_ = _ref1[0], r_ = 
_ref1[1];
    ...
    for (_i = 0, _len = op.length; _i < _len; _i++) {
      ...
      if (component.i != null) {
        ...
        if (component.d !== deleted) {
          throw new Error("Delete component '" + component.d + "' does not match 
deleted text '" + deleted + "'");
        }
        snapshot = snapshot.slice(0, component.p) + snapshot.slice(component.p + 
component.d.length);
      }
    }
    return snapshot;
  ...
  text._append = append = function(newOp, c) {
    ...
    if (newOp.length === 0) {
      ...
      if ((last.i != null) && (c.i != null) && (last.p <= (_ref = c.p) && _ref <= 
(last.p + last.i.length))) {
        return newOp[newOp.length - 1] = {
          i: strInject(last.i, c.p - last.p, c.i),
          p: last.p
        };
      } else if ((last.d != null) && (c.d != null) && (c.p <= (_ref1 = last.p) && 
_ref1 <= (c.p + c.d.length))) {
        return newOp[newOp.length - 1] = {
    ...
    if (c.i != null) {
      ...
      if (otherC.i != null) {
        ...
        if (c.p >= otherC.p + otherC.d.length) {
          ...
          otherIntersect = otherC.d.slice(intersectStart - otherC.p, intersectEnd - 
otherC.p);
          if (cIntersect !== otherIntersect) {
            throw new Error('Delete ops delete different text in the same region of 
the document');
          }
          if (newC.d !== '') {
  ...
  if (typeof WEB !== "undefined" && WEB !== null) {
    ...
    module.exports = text;
    require('./helpers').bootstrapTransform(text, transformComponent, checkValidOp, 
append);
  }
  ...
  Doc = (function() {
    ...
    Doc.prototype._onMessage = function(msg) {
      var callback, docOp, error, oldInflightOp, op, path, response, undo, value, 
_i, _j, _len, _len1, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6;
      ...
      switch (false) {
        case msg.open !== true:
          ...
          this.emit('open');
          return typeof this._openCallback === "function" ? this._openCallback(null) 
: void 0;
        case msg.open !== false:
          if (msg.error) {
        ...
        case !(msg.op === null && error === 'Op already submitted'):
          break;
        case !((msg.op === void 0 && msg.v !== void 0) || (msg.op && (_ref = 
msg.meta.source, __indexOf.call(this.inflightSubmittedIds, _ref) >= 0))):
          ...
          if (error) {
            if (this.type.invert) {
              ...
              if (this.pendingOp) {
                _ref1 = this._xf(this.pendingOp, undo), this.pendingOp = _ref1[0], 
undo = _ref1[1];
              }
              this._otApply(undo, true);
            } else {
              this.emit('error', "Op apply failed (" + error + ") and the op could 
not be reverted");
            }
        ...
        case !msg.op:
          ...
          if (msg.doc !== this.name) {
            return this.emit('error', "Expected docName '" + this.name + "' but got 
" + msg.doc);
          }
          if (msg.v !== this.version) {
            return this.emit('error', "Expected version " + this.version + " but got 
" + msg.v);
          }
          op = msg.op;
          ...
          if (this.inflightOp !== null) {
            _ref4 = this._xf(this.inflightOp, docOp), this.inflightOp = _ref4[0], 
docOp = _ref4[1];
          }
          if (this.pendingOp !== null) {
            _ref5 = this._xf(this.pendingOp, docOp), this.pendingOp = _ref5[0], 
docOp = _ref5[1];
          }
          this.version++;
...
console.warn('Unhandled meta op:', msg) : void 0;
          }
          break;
        default:
          return typeof console !== "undefined" && console !== null ? 
console.warn('Unhandled document message:', msg) : void 0;
      }
    };

    Doc.prototype.flush = function() {
      if (!(this.connection.state === 'ok' && this.inflightOp === null && 
this.pendingOp !== null)) {
        return;
      }
    ...
    function ReconnectingWebSocket(url, protocols, Socket) {
      ...
      connect = function(reconnectAttempt) {
        ...
        _this.ws.onmessage = function(event) {
          if (_this.debug) {
            console.debug("ReconnectingWebSocket", "onmessage", _this.url, 
event.data);
          }
...
re-open).
    For example, if the app suspects bad data / missed heart beats, it can try to 
refresh.
    */
  ...
  if (typeof WEB !== "undefined" && WEB !== null) {
    types = exports.types;
    BCSocket = window.BCSocket, SockJS = window.SockJS, WebSocket = 
window.WebSocket;
    if (BCSocket) {
      socketImpl = 'channel';
    } else {
    ...
    function Connection(host, authentication) {
      ...
      this.socket.onmessage = function(msg) {
        ...
        if (_this.docs[docName]) {
          ...
          return typeof console !== "undefined" && console !== null ? 
console.error('Unhandled message', msg) : void 0;
        }
      };
    ...
    Connection.prototype.open = function(docName, type, callback) {
      ...
      if (docName == null) {
        throw new Error('Server-generated random doc names are not currently 
supported');
      }
      if (this.docs[docName]) {
